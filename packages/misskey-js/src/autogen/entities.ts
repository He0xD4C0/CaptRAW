...
export type AdminOidcAppCreateRequest = operations['admin___oidc___app-create']['requestBody']['content']['application/json'];
export type AdminOidcAppCreateResponse = operations['admin___oidc___app-create']['responses']['200']['content']['application/json'];
export type AdminOidcAppDeleteRequest = operations['admin___oidc___app-delete']['requestBody']['content']['application/json'];
export type AdminOidcAppShowRequest = operations['admin___oidc___app-show']['requestBody']['content']['application/json'];
export type AdminOidcAppShowResponse = operations['admin___oidc___app-show']['responses']['200']['content']['application/json'];
export type AdminOidcAppsRequest = operations['admin___oidc___apps']['requestBody']['content']['application/json'];
export type AdminOidcAppsResponse = operations['admin___oidc___apps']['responses']['200']['content']['application/json'];
...
export type AdminSendSmsRequest = operations['admin___send-sms']['requestBody']['content']['application/json'];
...
export type IUpdatePhoneRequest = operations['i___update-phone']['requestBody']['content']['application/json'];
export type IUpdatePhoneResponse = operations['i___update-phone']['responses']['200']['content']['application/json'];
export type IUpdateQqResponse = operations['i___update-qq']['responses']['200']['content']['application/json'];
...
export type PhoneAvailableRequest = operations['phone___available']['requestBody']['content']['application/json'];
export type PhoneAvailableResponse = operations['phone___available']['responses']['200']['content']['application/json'];
export type PhoneSendCodeRequest = operations['phone___send-code']['requestBody']['content']['application/json'];
export type PhoneVerifyCodeRequest = operations['phone___verify-code']['requestBody']['content']['application/json'];
export type PhoneVerifyCodeResponse = operations['phone___verify-code']['responses']['200']['content']['application/json'];
...
export type SendPhoneVerificationRequest = operations['send-phone-verification']['requestBody']['content']['application/json'];
